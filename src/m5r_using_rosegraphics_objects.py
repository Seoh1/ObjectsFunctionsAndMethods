...
#            Default height is 300, wth default width of 400.
#
...
#                Square and polyton with defined number of sides.
...
#            When the programmer wish to observe the end results of the program.
#            The method allows the programmer to close the screen by clicking the window instead of it
#               shutting down itself, thus making it diffucult for the programmer to examine the result of the program.
#
